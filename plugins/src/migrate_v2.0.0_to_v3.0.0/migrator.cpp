/* ----------------------------------- Local -------------------------------- */
#include "migrate_v2.0.0_to_v3.0.0/migrator.h"
...
Migrator::migrate(const snap_v2_0_0::Snapshot &snapshot_from) const
{
...
ReverseMigrator::migrate(const snap_v3_0_0::Snapshot &snapshot_from) const
{
