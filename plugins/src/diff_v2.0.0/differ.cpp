  ...
  } else if (role == Qt::DecorationRole && index.column() == 0)
  {
    switch (node->change())
    {
      case ChangeType::Added:
        return QIcon(":/diff_v2.0.0/icons/green.png");
      case ChangeType::Removed:
        return QIcon(":/diff_v2.0.0/icons/red.png");
      case ChangeType::Modified:
        return QIcon(":/diff_v2.0.0/icons/blue.png");
      default:
        return QVariant();
    }
  }
...
QVersionNumber Differ::version() const { return QVersionNumber(2, 0, 0); }

QAbstractItemModel *Differ::diff(
  const QByteArray &src, const QByteArray &dest, QObject *parent) const
{
  auto snapshot_src = snap_v2_0_0::Snapshot{};
  auto snapshot_dest = snap_v2_0_0::Snapshot{};
